      ...
      <div class="content" @click="toggleList">
        <div class="content-left">
          <div class="logo-wrapper">
            ...
            <bubble class="num" v-show="totalCount > 0" :num="totalCount"></bubble>
          </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      _showShopCartSticky () {
        this.shopCartStickyComp = this.shopCartStickyComp || this
        .$createShopCartSticky({
          $props: {
      ...
      _hideShopCartList () {
        const comp = this.sticky ? this.$parent.list : this
          .shopCartListComp
        comp.hide && comp.hide()
      },
      _hideShopCartSticky () {
